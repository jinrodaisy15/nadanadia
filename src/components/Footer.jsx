...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className="bg-maroon-600 dark:bg-dark-surface py-16 px-4 relative overflow-hidden border-t border-maroon-500 dark:border-dark-border"
    >
      ...
      <div ref={ref} className="reveal relative z-10 max-w-2xl mx-auto text-center">
        {/* Names */}
        <h2
          className="font-dancing text-cream-100 font-bold"
          style={{ fontSize: 'clamp(3rem, 10vw, 5rem)' }}
        >
          Nada <span className="text-maroon-200 dark:text-dark-accent">♥</span> Nadia
        </h2>
