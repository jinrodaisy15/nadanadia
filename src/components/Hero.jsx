  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto">
        ...
        {/* Tagline */}
        <p className="reveal font-dancing text-maroon-400 text-xl sm:text-2xl mb-2 tracking-wide">
          ✦ Kisah Cinta Kita ✦
        </p>

        {/* Names */}
        <h1 className="reveal font-dancing font-bold leading-none text-maroon-600"
        ...
        <h1 className="reveal font-dancing font-bold leading-none text-maroon-500"
            style={{ fontSize: 'clamp(4rem, 14vw, 8rem)' }}>
          Nadia
        </h1>
